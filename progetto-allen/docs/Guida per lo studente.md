...
1. il testing del vostro codice (unit test con [JUnit](https://junit.org/)) e l'analisi dello stesso con strumenti di quality assurance (PMD, [Checkstyle](https://checkstyle.org/), [Spotbugs](https://spotbugs.github.io));
...
- Dopo l’esecuzione dei test è possibile lanciare gli strumenti di **Quality Assurance** (PMD, checkstyle e spotbugs) per assicurarsi di aver scritto codice di qualità. Leggere la sezione *Controlli di Qualità* per ulteriori informazioni.
